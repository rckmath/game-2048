...
public class GUI_EndGame extends JFrame {
    ...
    private void loadImages() {
        ...
        imgBtnMain.add(new ImageIcon(this.getClass().getResource("/imgs/buttons/btnMenuDef.png")));
        imgBtnMain.add(new ImageIcon(this.getClass().getResource("/imgs/buttons/btnMenuHov.png")));
        imgBtnMain.add(new ImageIcon(this.getClass().getResource("/imgs/buttons/btnMenuPre.png")));
