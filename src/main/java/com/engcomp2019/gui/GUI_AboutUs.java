...
public class GUI_AboutUs extends JFrame {
    ...
    private final ImageIcon imgFrame = new ImageIcon("src/main/resources/imgs/frames/frameAbout.png");
    ...
    private void loadImages() {
        ...
        imgGit.add(new ImageIcon("src/main/resources/imgs/buttons/other/btnGitDef.png"));
        imgGit.add(new ImageIcon("src/main/resources/imgs/buttons/other/btnGitHover.png"));
        imgGit.add(new ImageIcon("src/main/resources/imgs/buttons/other/btnGitPressed.png"));
    }
    // </editor-fold>
